...
Video::get (Detail d) const {
    ...
    switch (d) {
    case Link       : return QVariant (_link);
    case Title      : return QVariant (_title);
    case PageURL    : return QVariant (_pageURL);
    case ID         : return QVariant (_id);
    case Format     : return QVariant (_format);
    case Length     : return QVariant (_length);
    case Suffix     : return QVariant (_suffix);
    case ContentType: return QVariant (_ctype);
    case Host       : return QVariant(_host);
    }
...
Video::set (Detail d, const QString& s) {
    bool ignored = false;
    switch (d) {
    case Link       : _link     = s; break;
    case Title      : _title    = s; break;
    case PageURL    : _pageURL  = s; break;
    case ID         : _id       = s; break;
    case Format     : _format   = s; break;
    case Length     : _length   = s.toLongLong(&ignored); break;
    case Suffix     : _suffix   = s; break;
    case ContentType: _ctype    = s; break;
    case Host       : _host     = s; break;
    default         : break;
    }
}
